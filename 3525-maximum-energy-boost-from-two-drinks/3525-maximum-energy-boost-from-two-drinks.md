<h1>3525 - Maximum Energy Boost From Two Drinks</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/maximum-energy-boost-from-two-drinks/">maximum-energy-boost-from-two-drinks</a></h2><p>You are given two integer arrays <code>energyDrinkA</code> and <code>energyDrinkB</code> of the same length <code>n</code> by a futuristic sports scientist. These arrays represent the energy boosts per hour provided by two different energy drinks, A and B, respectively.</p>
