<h1>4100 - Complete Prime Number</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/complete-prime-number/">complete-prime-number</a></h2><p>You are given an integer <code>num</code>.</p>
