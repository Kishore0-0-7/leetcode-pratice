<h1>3834 - Minimum Operations to Convert All Elements to Zero</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-operations-to-convert-all-elements-to-zero/">minimum-operations-to-convert-all-elements-to-zero</a></h2><p>You are given an array <code>nums</code> of size <code>n</code>, consisting of <strong>non-negative</strong> integers. Your task is to apply some (possibly zero) operations on the array so that <strong>all</strong> elements become 0.</p>
