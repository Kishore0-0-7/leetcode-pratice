<h1>4291 - Minimum Cost to Move Between Indices</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-cost-to-move-between-indices/">minimum-cost-to-move-between-indices</a></h2><p>You are given an integer array <code>nums</code> where <code>nums</code> is <strong><span data-keyword="strictly-increasing-array">strictly increasing</span></strong>.</p>
